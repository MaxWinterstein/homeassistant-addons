...
- SMB/CIFS printing support via `smbclient` and CUPS SMB backend symlink, thanks to [@HeyITGuyFixIt](https://github.com/HeyITGuyFixIt) - see [#495](https://github.com/MaxWinterstein/homeassistant-addons/pull/495)
